window.onload = function(){
  ...
  var nikukyu_btn = document.getElementById("nikukyu_btn");
  
  var nikukyu = document.getElementById("test");
  console.log(nikukyu);
  
  function nikukyuAppear() {
    nikukyu.style.opacity = 1;
    window.setTimeout(nikukyuHide, 2000);
  }
  
  function nikukyuHide() {
    nikukyu.style.opacity = 0;
  }
  
  nikukyu_btn.addEventListener('click', nikukyuAppear);
  ...
  function slideShow(){
    ...
    var x;
    const img = document.querySelectorAll("img.img_content:not(.nikukyu)");
